...
User embb_table[] = {
    User(2, 100, 193, 0.3770), User(2, 355, 308, 0.6016), User(2, 455, 449, 0.8770),
    User(2, 767, 602, 1.1758), User(4, 763, 378, 1.4766), User(4, 534, 434, 1.6953),
    User(4, 233, 490, 1.9141), User(4, 33, 553, 2.1602), User(4, 837, 616, 2.4063),
    User(4, 76, 658, 2.5704), User(6, 87, 466, 2.7305), User(6, 876, 517, 3.0293),
    User(6, 76, 567, 3.3223), User(6, 87, 616, 3.6094), User(6, 99, 719, 4.2129),
    User(6, 76, 772, 4.5234), User(6, 95, 822, 4.8164), User(6, 111, 873, 5.1152),
    User(8, 6, 682.5, 5.3320), User(8, 88, 711, 5.5547), User(8, 11, 754, 5.8906),
    User(8, 222, 797, 6.2266), User(8, 777, 841, 6.5703), User(8, 98, 885, 6.9141),
    User(8, 76, 916.5, 7.1602), User(8, 88, 948, 7.4063)};
...
User urllc_table[] = {
    User(2, 111, 40, 0.0781), User(2, 123, 50, 0.0977), User(2, 87, 64, 0.1250),
    User(2, 73, 78, 0.1523), User(2, 100, 99, 0.1934), User(2, 123, 120, 0.2344),
    User(2, 874, 157, 0.3066), User(2, 76, 193, 0.3770), User(2, 87, 251, 0.4902),
    User(2, 98, 308, 0.6016), User(2, 876, 379, 0.7402), User(2, 999, 449, 0.8770),
    User(2, 99, 526, 1.0273), User(2, 99, 602, 1.1758), User(4, 81, 340, 1.3281),
    User(4, 88, 378, 1.4766), User(4, 543, 434, 1.6953), User(4, 987, 490, 1.9141),
    User(4, 11, 553, 2.1602), User(4, 87, 616, 2.4063), User(6, 66, 438, 2.5664),
    User(6, 333, 466, 2.7305), User(6, 123, 517, 3.0293), User(6, 88, 567, 3.3223),
    User(6, 88, 616, 3.6094), User(6, 666,666, 3.9023), User(6, 54, 719, 4.2129),
    User(6, 122, 772, 4.5234)};
...
int main()
{
       ...
       count++) // storing random no_of_embb_users values
  {
    //i = count;
    i = (rand() % 26); /////////////////////////////////////////////////////////////////////////////////////////////////////////////
    embb_user[count] = {embb_table[i].mod_index, embb_table[i].altitudes, [i].code_rate,
  ...
  {
    i = (rand() % 28);
    urllc_user[count] = {urllc_table[i].mod_index, urllc_table[i].altitudes, [i].code_rate,
  ...
  for (int count = 0; count < no_of_embb_users; count++) // storing channel quality of embb users
  {
    channel_quality_embb[count] =
        Utility::getChannelQuality(SNR_embb[count], power_embb[count],embb_user[count].altitudes);
  }

  for (int count = 0; count < no_of_urllc_users; count++) // storing channel quality of urllc users
  {
    channel_quality_urllc[count] =
        Utility::getChannelQuality(SNR_urllc[count], power_urllc[count],urllc_user[count].altitudes);
  }
